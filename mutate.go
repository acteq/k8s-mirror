...
func mutateResource(ar v1beta1.AdmissionReview, mirror map[string]string) *v1beta1.AdmissionResponse {
	podResource := metav1.GroupVersionResource{Group: "", Version: "v1", Resource: "pods"}
	deploymentResource := metav1.GroupVersionResource{Group: "apps", Version: "v1", Resource: "deployments"}
	if ar.Request.Resource == podResource {
		return mutatePods(ar, mirror)
	}else if ar.Request.Resource == deploymentResource {
		return mutateDeployments(ar, mirror)
	}else {
